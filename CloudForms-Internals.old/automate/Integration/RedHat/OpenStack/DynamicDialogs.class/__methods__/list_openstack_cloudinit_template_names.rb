=begin
list_openstack_cloudinit_template_names.rb

 Author: Kevin Morey <kevin@redhat.com>

Description: This method lists cloud-init customization template names that reside in the OpenStack System Image Type or
