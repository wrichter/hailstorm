...
treebase = "cn=users,cn=accounts,dc=hailstorm2,dc=coe,dc=muc,dc=redhat,dc=com"
ldap = Net::LDAP.new :host => "192.168.101.11",
     :port => 389,
     :auth => {
           :method => :simple,
