...
begin
  ...
  to="approver@hailstorm2.coe.muc.redhat.com"
  user=$evm.root["user"]
  ...
  body += "<br><br>To view this Request go to: <a href='https://#{$evm.root["miq_server"].hostname}/miq_request/show/#{@miq_request.id}'>https://#{$evm.root["miq_server"].hostname}/miq_request/show/#{@miq_request.id}</a>"
  body+="</br>Regards,"
