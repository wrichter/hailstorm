=begin
  vcenter_mount_tools_installer.rb
...
begin
  ...
  #log(:warn, "mount_tools_installer_result: #{mount_tools_installer_result.inspect}")
  log(:info, "mount_tools_installer_result: #{mount_tools_installer_result.success?}")
