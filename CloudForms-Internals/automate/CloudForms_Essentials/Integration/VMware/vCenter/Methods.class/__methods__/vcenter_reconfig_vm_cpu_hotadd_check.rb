=begin
  vcenter_reconfig_vm_cpu_hotadd_check.rb
...
begin
  ...
  log('info', "vm_config_result cpuHotAddEnabled: #{cpuHotAddEnabled.inspect} vm_config_result[:cpu_hot_add_enabled]: #{vm_config_result[:cpu_hot_add_enabled].inspect}")
