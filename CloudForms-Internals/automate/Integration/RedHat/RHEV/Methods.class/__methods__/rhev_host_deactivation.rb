=begin
 rhev_host_deactivation.rb

 Author: Kevin Morey <kevin@redhat.com>

 Description: This method evacuates a RHEV host by putting it into maintenance mode
-------------------------------------------------------------------------------
...
begin
  ...
  when 'host'
    ...
    deactivate_host_response = call_rhev(:post, "#{@host.ems_ref}/deactivate", :xml, '<action></action>')
