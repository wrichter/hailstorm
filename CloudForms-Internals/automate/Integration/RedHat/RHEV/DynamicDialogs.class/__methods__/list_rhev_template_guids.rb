=begin
 list_rhev_template_guids.rb

 Author: Kevin Morey <kevin@redhat.com>

 Description: This method lists RHEV template guids
-------------------------------------------------------------------------------
...
if provider
  ...
  $evm.vmdb(:ManageIQ_Providers_Redhat_InfraManager_Template).all.each do |template|
    next if template.archived || template.orphaned
