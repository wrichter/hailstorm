=begin
list_rhev_vm_snapshot_refs.rb

 Author: Kevin Morey <kevin@redhat.com>

 Description: This is method builds a list of RHEV VM snapshots
-------------------------------------------------------------------------------
...
snapshots_array.each do |ss|
  ...
  if ss['snapshot_status'] == 'locked'
    snapshot_locked = true
    dialog_hash = {}
    dialog_hash[''] = "error: #{ss['description']} is: #{ss['snapshot_status']}, check back again later.."
    break
  else
    description += " - [#{ss['snapshot_status']}]"
    dialog_hash[ss['href']] = description
  end
end
