=begin
 list_openstack_cloudinit_template_ids.rb

 Author: Kevin Morey <kevin@redhat.com>

 Description: This method lists cloud-init customization template ids that reside in the OpenStack System Image Type or
