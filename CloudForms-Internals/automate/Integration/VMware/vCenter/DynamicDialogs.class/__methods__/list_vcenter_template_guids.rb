=begin
list_vcenter_template_guids.rb

 Author: Kevin Morey <kevin@redhat.com>

 Description: This method builds a dialog of all vmware tempalate guids based 
...
dialog_hash = {}
$evm.vmdb(:ManageIQ_Providers_Vmware_InfraManager_Template).all.each do |template|
